...
// in freegosy/test/unit/device_id_provider_test.dart.
...
class MockRommService extends _i1.Mock implements _i4.RommService {
  ...
  @override
  _i6.Future<void> sendActivityHeartbeat({
    required String? romId,
    required String? deviceId,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> clearActivityHeartbeat({required String? deviceId}) =>
      (super.noSuchMethod(
